export const Icons = {
  ...
  tiktokFooter: {
    paths: [
      {
        d: 'M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.81-.6-4.03-1.37-.36 3.39-.17 6.84-1.33 10.01-1.07 2.93-3.76 5.31-6.95 5.33-2.09.05-4.22-.59-5.72-2.03-1.84-1.72-2.52-4.48-1.64-6.89.81-2.29 2.94-4.05 5.35-4.31.07 1.74.21 3.49.33 5.23-.97.12-2.03.62-2.51 1.56-.54 1.05-.31 2.45.54 3.31.84.85 2.21.96 3.16.27.97-.68 1.25-2.01 1.04-3.15-.02-3.83-.02-7.66-.01-11.49 1.34-.02 2.68-.02 4.02-.02.02-.57.01-1.14.02-1.71-.03-.94-.02-1.87-.01-2.81z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
